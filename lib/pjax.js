...
Pjax = (function(superClass) {
  ...
  Pjax.prototype.load = function(url, opts) {
    var $page, page, pageId, ref, scrollPosition, state;
    ...
    if (page && !page.nocache && !opts.nocache) {
      if (opts.scrollPosition && ((ref = page.params) != null ? ref.scrollPosition : void 0)) {
      ...
      this.restoreScrollPosition(this.el.children().first(), scrollPosition);
    ...
    if (opts.norefresh && page) {
      ...
      return this.requestPage(page, scrollPosition);
    }
  };

  Pjax.prototype.requestPage = function(page, scrollPosition) {
    return this.request = $.ajax({
      ...
      success: (function(_this) {
        return function(result, status, xhr) {
          ...
          return _this.loadPage(page, xhr, scrollPosition);
        };
      })(this)
    });
  };

  Pjax.prototype.loadPage = function(page, xhr, scrollPosition) {
    ...
    if (page) {
      ...
      $('.actions-menu, .todo-priority-menu, .todolist-group-title-menu').remove();
      this.el.empty().append($page);
      if (scrollPosition && (scrollPosition.top !== 0 || scrollPosition.left !== 0)) {
        this.restoreScrollPosition($page, scrollPosition);
      }
      this.el.offsetHeight;
  ...
  Pjax.prototype.restoreScrollPosition = function($page, scrollPosition) {
    var $scrollContainer, error;
    try {
    ...
    return $scrollContainer.scrollTop(scrollPosition.top).scrollLeft(scrollPosition.left);
  };
